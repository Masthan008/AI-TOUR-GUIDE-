...
export const VoiceControl: React.FC<VoiceControlProps> = ({ isListening, isSupported, startListening, stopListening, error }) => {
  ...
  return (
    <div className="fixed bottom-6 right-6 z-50 flex flex-col items-end gap-2">
       {errorMessage && (
        <div 
          className="px-4 py-2 bg-red-800/90 text-white text-sm rounded-lg shadow-lg"
      ...
      <button
        ...
        className={`w-16 h-16 rounded-full flex items-center justify-center shadow-2xl transition-all duration-300 ease-in-out transform active:scale-90
